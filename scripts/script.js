...
function mainSearch() {
  ...
  let result = filterByIngredients(recipeList);
  // console.log(result.recipeList);
  // console.log(result.uniqueIngredientNames);
  ingredientDropdownShow(result.uniqueIngredientNames);
